    ...
    const templates = [
      ...
      },
      {
        ...
        customCss: `
          ...
          .amount-table th { background: #065f46; color: white; padding: 7px 10px; }
          .amount-table td { border-bottom: 1px solid #d1fae5; padding: 6px 10px; }
          .amount-table tr:nth-child(even) td { background: #f0fdf4; }
          .total-row td { background: #dcfce7 !important; border-top: 2px solid #065f46 !important; }
