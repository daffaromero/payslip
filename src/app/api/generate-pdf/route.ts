  ...
  try {
    ...
    const pdfBuffer = await generatePayslipPDF({
      ...
      employee: {
        ...
        position: payslip.employee.position || undefined,
        npwp: payslip.employee.npwp || undefined,
        ...
        hourlyRate: payslip.employee.hourlyRate || undefined,
      ...
      company: {
        ...
        address: payslip.company.address || undefined,
        taxId: payslip.company.taxId || undefined,
        phone: payslip.company.phone || undefined,
        email: payslip.company.email || undefined,
        logoUrl: payslip.company.logoUrl || undefined,
      },
    })
